...
public class Asteroid extends MovingObject {
	...
	private final double[] ANGLES = {0,	22.5,	45,	 67.5,
							   90,	112.5,	135, 157.5, 
							   180, 202.5,	225, 247.5, 
							   270, 292.5,	315, 337.5};	
	...
	public void checkLocation(Point center, float size){		
		...
		boolean horizontalRight = (this.horizontalRightDown && this.horizontalRightUp);//Right side within visibility range
